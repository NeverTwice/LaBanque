...
int main(int argc, char* argv[]) {
    ...
    ret = sqlite3_open_v2 (getConfig.db_name, &dbc,
    ...
    dump_db (dbc, "/Users/YANN/Desktop/LaBanque/toto.sql");
    system("date +%x_%H:%M:%S:%N");
    ...
    FILE *f;
    char c;
    f=fopen("/Users/YANN/Desktop/LaBanque/toto.sql", "r");
